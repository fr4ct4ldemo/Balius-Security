/**
 * images.js — Base64 image loader for Balius bot
 *
 * Reads all bot images from the balius assets folder at runtime and
...
// Balius assets folder is now inside project2.0 root
const ASSETS_DIR = path.join(__dirname, '..', 'balius');
...
const images = {
  ...
  balius:        loadImage('discotools-xyz-icon.png'), // balius.png not present — using discotools icon as fallback
