...
const { buildHomeEmbed, buildMenuRow } = require('../utils/helpEmbed');
...
// buildHomeEmbed is provided by utils/helpEmbed to avoid circular requires
...
// ─── Component builders ───────────────────────────────────────────────────────
// buildMenuRow is imported from utils/helpEmbed
    ...
    try {
      ...
      if (interaction.isStringSelectMenu() && interaction.customId === HELP_MENU_ID) {
        ...
        await interaction.update({
          embeds: [embed ?? new EmbedBuilder().setColor(0x7C3AED).setDescription('Unknown category.')],
